TYPEINFO_DEF(/obj/item/clothing/under/rank/security/hunk)
	default_armor = list(BLUNT = 5, PUNCTURE = 10, SLASH = 10, LASER = 10,ENERGY = 10, BOMB = 0, BIO = 0, FIRE = 50, ACID = 40)
