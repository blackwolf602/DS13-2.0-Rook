...
/datum/species/necromorph
	...
	reagent_flags = NONE
	//Dear LORD this flag is sizable
	no_equip_flags = ITEM_SLOT_OCLOTHING | ITEM_SLOT_ICLOTHING | ITEM_SLOT_GLOVES | ITEM_SLOT_EYES | ITEM_SLOT_EARS | ITEM_SLOT_MASK | ITEM_SLOT_HEAD | ITEM_SLOT_FEET | ITEM_SLOT_ID | ITEM_SLOT_BELT | ITEM_SLOT_BACK | ITEM_SLOT_DEX_STORAGE | ITEM_SLOT_NECK | ITEM_SLOT_BACKPACK | ITEM_SLOT_SUITSTORE | ITEM_SLOT_LPOCKET | ITEM_SLOT_RPOCKET | ITEM_SLOT_HANDCUFFED | ITEM_SLOT_LEGCUFFED
